...
class TranslationTextEntry extends React.Component {
    ...
    render() {
        ...
        return <>
            ...
            <textarea dir="auto" readOnly={!this.props.editable} placeholder="Enter the translation here." ref={element => this.translatedTextArea = element} value={this.props.translation.msgstr[this.props.index]} className={Styles.TranslatedText} onChange={changeEvent} />
            {this.renderChecks()}
        </>
    }
}
