...
import ManageTwoFactorAuthenticationModal from "./ManageTwoFactorAuthenticationModal";
        ...
        return <div className={Styles.SiteAdministration}>
            <div className={Styles.SiteAdministrationContents}>
                ...
                <div>
                    ...
                    <div className={Styles.SectionItem} onClick={() => Modal.mount(<ManageTwoFactorAuthenticationModal />)}>{this.props.t("PROFILE_TWO_FACTOR_AUTHENTICATION")}</div>
                </div>
            </div>
        </div>
    }
